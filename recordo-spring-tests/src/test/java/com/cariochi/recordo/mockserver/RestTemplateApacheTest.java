...
class RestTemplateApacheTest {

    @Autowired
    protected GitHub gitHub;

    @Test
    @MockServer("/mockserver/resttemplate-apache/should_retrieve_gists.rest.json")
    ...
    @Test
    @MockServer("/mockserver/resttemplate-apache/should_create_gist.rest.json")
