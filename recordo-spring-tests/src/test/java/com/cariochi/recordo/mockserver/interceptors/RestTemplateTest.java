...
@SpringBootTest(classes = RestTemplatesConfig.class)
...
class RestTemplateTest {
    ...
    void should_get_exception() {
        assertThatThrownBy(() -> {
            try (RecordoMockServer mockServer = new RecordoMockServer(recordoInterceptor, "/mockserver/resttemplate/several_requests.rest.json")) {
                gitHub.getGists();
            }
        })
